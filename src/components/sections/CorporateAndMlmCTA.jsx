...
export default function CorporateAndMlmCTA() {
  return (
    <section className="py-24 bg-slate-50 relative overflow-hidden border-t border-slate-200/80">
      <div className="absolute inset-0 z-0 bg-[radial-gradient(circle_at_10%_20%,rgba(37,99,235,0.06),transparent_50%),radial-gradient(circle_at_90%_80%,rgba(245,158,11,0.04),transparent_50%)]" />
      ...
      <div className="container-custom relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="p-8 md:p-10 rounded-3xl bg-white border border-slate-200/80 hover:border-primary/40 transition duration-300 flex flex-col justify-between space-y-8 relative overflow-hidden group shadow-sm">
            <div className="space-y-5">
              ...
              <div>
                <h3 className="text-2xl md:text-3xl font-extrabold text-slate-900 mb-2">Corporate Partner Program</h3>
            ...
            <div className="pt-6 border-t border-slate-100 flex flex-col sm:flex-row gap-2.5">
              <Link
                href="/corporate-partner"
                className="py-3 px-4 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-800 font-bold text-xs flex items-center justify-center border border-slate-200 transition text-center"
              >
              ...
              <Link
                href="/nextview/login"
                className="py-3 px-4 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-800 font-semibold text-xs flex items-center justify-center border border-slate-200 transition"
              >
                <span>Login</span>
              </Link>
            </div>
          ...
          <div className="p-8 md:p-10 rounded-3xl bg-white border border-slate-200/80 hover:border-amber-500/40 transition duration-300 flex flex-col justify-between space-y-8 relative overflow-hidden group shadow-sm">
            <div className="space-y-5">
              ...
              <div>
                <h3 className="text-2xl md:text-3xl font-extrabold text-slate-900 mb-2">NexVia 3×15 Network</h3>
                <p className="text-sm text-text-secondary leading-relaxed">
