      ...
      <div className="container-custom">
        <div className="flex h-20 items-center justify-between gap-4">
          <Link href="/" className="flex items-center gap-3">
            <div className="flex h-10 w-10 items-center justify-center rounded-xl border border-white/10 bg-blue-500/10 text-sm font-bold text-white">
              AS
            </div>
              ...
              return (
                <Link
                  ...
                  className={`relative px-4 py-2 text-sm font-medium transition-colors ${
                    active ? 'text-blue-400' : 'text-text-secondary hover:text-white'
                  }`}
                >
                  {link.label}
                  <span
                    className={`absolute left-4 right-4 -bottom-0.5 h-0.5 rounded-full bg-blue-500 transition-all ${
